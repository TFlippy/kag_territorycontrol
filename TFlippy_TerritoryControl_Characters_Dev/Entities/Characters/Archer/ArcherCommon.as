...
bool hasArrows(CBlob@ this)
{
	...
	else if (archer.arrow_type >= 0 && archer.arrow_type < arrowTypeNames.length)
	{
...
{
	if (arrowType == ArrowType::normal) return true;
	else return this.getBlobCount(arrowTypeNames[arrowType]) > 0;
}
