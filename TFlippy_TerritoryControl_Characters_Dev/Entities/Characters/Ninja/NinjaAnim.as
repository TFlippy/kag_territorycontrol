...
{
	addRunnerTextures(this, "ninja", "Ninja");
...
{
	ensureCorrectRunnerTexture(this, "ninja", "Ninja");
}
...
void onTick(CSprite@ this)
{
	...
	if (ninja.state == NinjaStates::sword_drawn || ninja.state == NinjaStates::sword_cut_mid || ninja.state == NinjaStates::sword_cut_mid_down || ninja.state == NinjaStates::sword_cut_up || ninja.state == NinjaStates::sword_cut_down)
	{
