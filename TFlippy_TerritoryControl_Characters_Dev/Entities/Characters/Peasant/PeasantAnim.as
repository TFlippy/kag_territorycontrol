...
{
	addRunnerTextures(this, "peasant", "Peasant");
...
{
	ensureCorrectRunnerTexture(this, "peasant", "Peasant");
}
...
void onRender(CSprite@ this)
{
	...
	if ((blob.isKeyPressed(key_action1) && !blob.hasTag("noLMB")) || this.isAnimation("strike"))
	{
