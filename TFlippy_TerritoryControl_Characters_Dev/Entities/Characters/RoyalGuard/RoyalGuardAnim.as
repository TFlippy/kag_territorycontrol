...
{
	addRunnerTextures(this, "royalguard", "RoyalGuard");
...
{
	ensureCorrectRunnerTexture(this, "royalguard", "RoyalGuard");
}
...
void onTick(CSprite@ this)
{
	...
	bool pressed_a1 = blob.isKeyPressed(key_action1) && !blob.hasTag("noLMB");
	bool pressed_a2 = blob.isKeyPressed(key_action2) && !blob.hasTag("noShielding");
...
void onRender(CSprite@ this)
{
	...
	if (blob.isKeyPressed(key_action1) && !blob.hasTag("noLMB"))
	{
