...
void onTick(CBlob@ this)
{
	...
	else if ((pressed_a1 || swordState) && !moveVars.wallsliding)   //no attacking during a slide
	{
		...
		if (knight.state == KnightStates::normal ||
		        (this.isKeyJustPressed(key_action1) && !this.hasTag("noLMB")) &&
	...
	else if ((this.isKeyJustReleased(key_action2) || this.hasTag("noShielding")) || (this.isKeyJustReleased(key_action1) && !this.hasTag("noLMB")) || this.get_u32("knight_timer") <= getGameTime())
	{
		knight.state = KnightStates::normal;
	}
