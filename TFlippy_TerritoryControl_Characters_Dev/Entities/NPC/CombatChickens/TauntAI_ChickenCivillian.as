...
void onInit(CBlob@ this)
{
	...
	//chats
	{
		string[] temp = { 
						  "Hoyl shet, a human!",
						  "They look worse than I thought.",
						  "Git gud",
						  "Ey, guards, there's some derpo over here.",
						  "Hello!"
						  "Take that!",
						  "Get owned!",
						  "Get run over!",
						  "I'm gonna pop your eye!",
						  "Get broke on spending yer money on lottery",
						  "Can't catch me",
						  "nub",
						  "I shall rend ya in the gobberwarts with my blurglecruncheon."
		                };
		b.taunts = temp;
	}
	{
		string[] temp = { 
							...
							"i hope you'll die as a 90 year old gigolo",
							"wut",
							"???",
							"gah",
							"yoargh"
	...
	{
		string[] temp = { 
							"Have you bought the badger plushy?",
							"Why did we even go here?",
							...
							"Thanks",
							"Okay",
							"Some guy jumped into a pit yesterday.",
							"He was annoying.",
							...
							"Why?",
							"Nah, I just shot him.",
							"Go to hell with Jerry, he's screwed anyway.",
							"Goddamnit"
		                };
		b.talks = temp;
	}
