...
void onInit(CBlob@ this)
{
	...
	}
	{
		string[] temp = { 
							...
							"Godverdomme",
							"Kutzooi",
							"Ik sla je op je muil als je",
							"Je bek nu niet houdt",
							"Heef iemand nog een lekker kaasje?",
							"Wanneer gaan we die domme kippen nou plunderen?",
							"Godsanne"
		                };
		b.talks = temp;
	}
