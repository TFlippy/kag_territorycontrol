...
void onInit(CBlob@ this)
{
	...
	string name = firstnames[rand.NextRanged(firstnames.length)];
...
void Stomp(CBlob@ this, int count, f32 magnitude)
{
	...
	if (client)
	{
		...
		if (localplayerblob !is null && localplayerblob !is this) // if we are the hoob, we should be use to our old movement (so we dont need the screenshake)
		{
