...
const int MAX_EGGS = 10; //maximum symultaneous eggs
const int MAX_CHICKENS = 6;
const f32 CHICKEN_LIMIT_RADIUS = 120.0f;

const float soundPitch = 0.50f;
...
void onTick(CSprite@ this)
{
	...
	else
	{
		...
		this.PlaySound("/BisonBoo", 1.00f, 2.30f);
	}
}
...
void onTick(CBlob@ this)
{
	...
	{
		this.getSprite().PlaySound("/Pluck", 1.00f, soundPitch);
...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1)
{
	...
	{
		this.getSprite().PlaySound("/BisonBoo", 1.00f, 2.30f);
		g_lastSoundPlayedTime = getGameTime();
	}
}
