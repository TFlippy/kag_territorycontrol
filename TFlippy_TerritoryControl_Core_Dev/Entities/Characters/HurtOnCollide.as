...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1)
{
	if (solid)
	{
		...
		if (blob is null)
		{
			...
			if (blob.getTeamNum() != this.getTeamNum() || (this.getTeamNum()<0 || this.getTeamNum()>=7))
			{
				...
				if (mass < veryHeavy &&
				        ...
				        (damagePlayer.getBlob().getTeamNum()==blob.getTeamNum() || ((damagePlayer.getTeamNum()<0 || damagePlayer.getTeamNum()>=7) && (blob.getTeamNum()<0 || blob.getTeamNum()>=7))))
				{
					return;
				}
