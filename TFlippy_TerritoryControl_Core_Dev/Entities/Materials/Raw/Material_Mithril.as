...
void MakeParticle(CBlob@ this, float magnitude)
{
	...
	CParticle@ p = ParticleAnimated(CFileMatcher("FalloutGas").getFirst(), this.getPosition() + getRandomVelocity(0, magnitude, 360), Vec2f(), float(XORRandom(360)), 1.00f + (magnitude * (XORRandom(100) / 100.0f)), 3 + (3 * magnitude), -0.05f, false);
	if (p !is null)
	{
