...
const LootItem@[] c_items =
{
	...
	LootItem("bp_automation", 1, 0, 10000),
	LootItem("bp_energetics", 1, 0, 5000),
	LootItem("bp_chemistry", 1, 0, 10000),
	LootItem("bp_induction", 1, 0, 20000),
	LootItem("bp_enrichment", 1, 0, 20000),
	LootItem("theory_automation", 1, 0, 1000),
	LootItem("theory_energetics", 1, 0, 500),
	LootItem("theory_chemistry", 1, 0, 1000),
	LootItem("theory_induction", 1, 0, 2000),
	LootItem("theory_enrichment", 1, 0, 2000),
