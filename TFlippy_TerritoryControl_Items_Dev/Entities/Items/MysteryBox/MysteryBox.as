...
LootItem@[] c_items =
{
	LootItem("mat_stone", 0, 1000, 800),
	LootItem("mat_wood", 0, 1000, 1),
	LootItem("mat_gold", 0, 500, 400),
	LootItem("mat_sulphur", 0, 250, 550),
	LootItem("mat_coal", 0, 100, 600),
	...
	LootItem("mat_goldingot", 0, 25, 105),
	LootItem("mat_steelingot", 0, 25, 254),
	LootItem("artisancertificate", 0, 1, 600),
	LootItem("mat_mithrilingot", 0, 25, 51),
