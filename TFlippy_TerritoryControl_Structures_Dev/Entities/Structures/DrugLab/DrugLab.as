...
const f32 max_pressure = 100000.00f;
		...
		if (inv !is null)
		{
			...
			if (pressure > 20000 && heat > 300 && hasMustard && hasFuel)
			{
				...
				if (getNet().isServer())
				{
					...
					Material::createFor(this, "mat_acid", count * 1.50f);
				}
				this.getSprite().PlaySound("DrugLab_Create_Acidic.ogg", 1.00f, 1.00f);
			}
			
			if (pressure > 15000 && heat > 750 && meat_blob !is null)
			{
				f32 count = Maths::Min(meat_count, pressure * 0.00025f);
			...
			if (pressure > 10000 && pressure < 50000 && heat > 1000 && hasOil)
			{
				...
				if (getNet().isServer())
				{
					...
					Material::createFor(this, "mat_fuel", count * 0.50f);
					Material::createFor(this, "mat_acid", count * 0.25f);
			...
			if (pressure > 25000 && heat > 1500 && hasMithril && hasAcid && mithril_count >= 50 && acid_count >= 25)
			{
				if (getNet().isServer())
				{
					...
					Material::createFor(this, "domino", 1 + XORRandom(2));
					Material::createFor(this, "mat_mithrilenriched", XORRandom(3));
					Material::createFor(this, "mat_fuel", XORRandom(25));
				}
			...
			if (pressure > 25000 && heat > 400 && hasSulphur && hasAcid && sulphur_count >= 25 && acid_count >= 50)
			{
				if (getNet().isServer())
				{
					...
					Material::createFor(this, "stim", 1 + XORRandom(2));
			...
			if (heat > 1500 && dirt_blob !is null && meat_blob !is null && hasAcid && dirt_count >= 50 && meat_count > 15 && acid_count >= 25)
			{
				if (getNet().isServer())
				{
					...
					Material::createFor(this, "bobongo", 1 + XORRandom(2));
			...
			if (pressure < 50000 && heat > 100 && hasDirt && hasAcid)
			{
				...
				if (getNet().isServer())
				{
					...
					Material::createFor(this, "mat_sulphur", count * 0.50f);
				}
				this.getSprite().PlaySound("DrugLab_Create_Acidic.ogg", 1.00f, 1.00f);
			}
			...
			if (pressure > 20000 && heat > 1000 && heat < 2000 && hasAcid && hasOil && acid_count >= 25 && oil_count >= 20)
			{
				...
				if (bobomax !is null)
				{
					if (getNet().isServer())
					{
						...
						Material::createFor(this, "foof", 1 + XORRandom(4));
					}
					this.getSprite().PlaySound("DrugLab_Create_Solid.ogg", 1.00f, 1.00f);
				}
			}
			
			if (pressure < 30000 && heat > 100 && heat < 1000 && hasAcid && hasMithril && acid_count >= 15 && mithril_count >= 5)
			{
				if (getNet().isServer())
				{
					...
					Material::createFor(this, "domino", XORRandom(1));
				}
				this.getSprite().PlaySound("DrugLab_Create_Solid.ogg", 1.00f, 1.00f);
			}
		}	
