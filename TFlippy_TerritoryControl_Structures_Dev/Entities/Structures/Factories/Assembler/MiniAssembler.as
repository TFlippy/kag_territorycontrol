...
void onInit(CSprite@ this)
{
...

	{
		...
		CSpriteLayer@ gear = this.addSpriteLayer("gear1", "MiniAssembler.png" , 16, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());

		if (gear !is null)
		{
			Animation@ anim = gear.addAnimation("default", 0, false);
			anim.AddFrame(5);
			gear.SetOffset(Vec2f(-2.0f, -3.0f));
...

	{
		...
		CSpriteLayer@ gear = this.addSpriteLayer("gear2", "MiniAssembler.png" , 16, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());

		if (gear !is null)
		{
			Animation@ anim = gear.addAnimation("default", 0, false);
			anim.AddFrame(5);
			gear.SetOffset(Vec2f(9.0f, -8.0f));
			gear.SetAnimation("default");
			gear.SetRelativeZ(-60);
