...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	if (canChangeClass(this, caller) && caller.getTeamNum() < 100)
	{
...
{
	return ((forBlob.getTeamNum() == this.getTeamNum() || this.getTeamNum() >= 100) && forBlob.isOverlapping(this) && canSeeButtons(this, forBlob));
}
