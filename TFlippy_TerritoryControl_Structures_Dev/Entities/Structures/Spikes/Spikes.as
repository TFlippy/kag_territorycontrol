//Remove this file once vanilla/engine is fixed!
//This file fixes an engine bug where isTileSolid() uses tiletype incorrectly, so spikes are compatible with TC custom tiles.
