...
void onInit(CBlob@ this)
{
	GunInitProjectile(
		...
		"mat_acid",			//Ammo item blob name
		true,				//If true, firing sound will be looped until player stops firing
		SoundInfo("FlamethrowerFire", 1, 1.0f, 2.00f),		//Sound to play when firing
		...
		Vec2f(0.0f,-8.0f)	//Offset for projectiles
	);
}
