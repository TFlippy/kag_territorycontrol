...
void onInit(CBlob@ this)
{
	...
	settings.AMMO_BLOB = "mat_mithrilenriched"; //Ammunition the gun takes
	...
	//Sound
	settings.FIRE_SOUND = "InfernoCannon_Shoot.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "ChargeLanceCycle.ogg"; //Sound when reloading
	...
	this.set_string("ProjBlob", "infernoprojectile");
}
/*
