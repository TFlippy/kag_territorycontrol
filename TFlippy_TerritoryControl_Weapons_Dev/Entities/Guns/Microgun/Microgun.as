...
void onInit(CBlob@ this)
{
	...
	settings.AMMO_BLOB = "ammo_gatling"; //Ammunition the gun takes
	...
	settings.B_TTL = 6; //TTL = 'Time To Live' which determines the time the bullet lasts before despawning
