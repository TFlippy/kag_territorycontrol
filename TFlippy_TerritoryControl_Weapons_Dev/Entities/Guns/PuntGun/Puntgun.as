...
void onInit(CBlob@ this)
{
	...
	//Bullet
	settings.B_PER_SHOT = 20; //Shots per bullet | CHANGE B_SPREAD, otherwise both bullets will come out together
	...
	//Sound
	settings.FIRE_SOUND = "PuntgunFire.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "ShotgunReload.ogg"; //Sound when reloading

	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-32, -3); //Where the muzzle flash appears
