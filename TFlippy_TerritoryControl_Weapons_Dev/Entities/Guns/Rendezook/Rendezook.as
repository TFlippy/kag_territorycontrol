...
void onInit(CBlob@ this)
{
	...
	settings.RELOAD_TIME = 28; //Time it takes to reload (in ticks)
	...
	//Sound
	settings.FIRE_SOUND = "Rendezook_shoot.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "Rendezook_load.ogg"; //Sound when reloading
