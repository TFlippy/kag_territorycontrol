...
void onInit(CBlob@ this)
{
	...
	settings.B_SPEED = 10; //Bullet speed, STRONGLY AFFECTED/EFFECTS B_GRAV
	...
	//Sound
	settings.FIRE_SOUND = "Zatniktel_Shoot.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "Zatniktel_Pickup.ogg"; //Sound when reloading

	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-6, -2); //Where the muzzle flash appears
	...
	this.set_string("ProjBlob", "zatniktelprojectile");
